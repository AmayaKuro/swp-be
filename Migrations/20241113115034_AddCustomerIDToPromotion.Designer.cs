...
namespace swp_be.Migrations
{
    ...
    [Migration("20241113115034_AddCustomerIDToPromotion")]
    partial class AddCustomerIDToPromotion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("swp_be.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = 3001,
                            Name = "Admin",
                            Password = "$2a$11$JuCmfGHoi0Zh8JVCxsJD1.BJ4tPzdvirHbN4Dz4RKgbOYpvFLr7G2",
                            Role = 0,
                            Username = "admin"
                        },
                        new
                        {
                            UserID = 3002,
                            Name = "Staff",
                            Password = "$2a$11$F5NgIK89Ns3xBj0eNi5la.NtVZFBWjnVXFZVKWo7j0RoFc.SjbA2S",
                            Role = 1,
                            Username = "staff"
                        },
                        new
                        {
                            UserID = 3003,
                            Name = "Customer",
                            Password = "$2a$11$wtSNvJkk/6zVupcQK7soh.s2ShL.RhpBd/IpHqBdPW/23PlBZhz1K",
                            Role = 2,
                            Username = "customer"
                        },
                        new
                        {
                            UserID = 3004,
                            Name = "String",
                            Password = "$2a$11$XpgCF9VvdyCmzw34AdhrZulCNvRSzxhAPxVSVEJj20OhrHgiS8dJG",
                            Role = 0,
                            Username = "string"
                        });
                });
