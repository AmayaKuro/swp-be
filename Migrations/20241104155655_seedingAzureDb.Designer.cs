...
namespace swp_be.Migrations
{
    ...
    [Migration("20241104155655_seedingAzureDb")]
    partial class seedingAzureDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("swp_be.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = 3001,
                            Name = "Admin",
                            Password = "$2a$11$MbTPtiZoJeW6cq0AQNaRHO7nxhAFZziEgZCpw9jnkn9w2IDHN4XPa",
                            Role = 0,
                            Username = "admin"
                        },
                        new
                        {
                            UserID = 3002,
                            Name = "Staff",
                            Password = "$2a$11$KjtdT24KauwLrb1noW953uPp3s.qufZ9eeEFtB7JeVCE5ajAGmQOa",
                            Role = 1,
                            Username = "staff"
                        },
                        new
                        {
                            UserID = 3003,
                            Name = "Customer",
                            Password = "$2a$11$72676Sg4jrThpygSAdSAneEG7i7gHCS8S58ULmp.4fzUFAqjXOZOO",
                            Role = 2,
                            Username = "customer"
                        },
                        new
                        {
                            UserID = 3004,
                            Name = "String",
                            Password = "$2a$11$Ax2shEbEjdACCfZlocV.LuJKiGsaWPRFrdgIYDMs3MCXbMtG0OnC2",
                            Role = 0,
                            Username = "string"
                        });
                });
